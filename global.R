...
wq_measure<-c("Impaired Watershed Area -- EPA '303(d)' list "="wq1","Hydrologic Response to Land-Use Change "="wq2","Percent Irrigated Agriculture "="wq3","Lateral Connectivity to Floodplain "="wq4","Composition of Riparian Zone Lands "="wq5","Hydromodification: Number of Impoundments "="wq6")
lcmr_measure<-c("Biodiversity Index "="lcmr1", "Threatened and Endangered Species - Critical Habitat Area "="lcmr2","Threatened and Endangered Species - Number of Species "="lcmr3","Light Pollution Index "="lcmr4","Terrestrial Vertebrate Biodiversity "="lcmr5")
...
wq_measure_name<-c("Impaired Watershed Area -- EPA '303(d)' list ","Hydrologic Response to Land-Use Change ","Percent Irrigated Agriculture ","Lateral Connectivity to Floodplain ","Composition of Riparian Zone Lands ","Hydromodification: Number of Impoundments ")
lcmr_measure_name<-c("Biodiversity Index ", "Threatened and Endangered Species - Critical Habitat Area ","Threatened and Endangered Species - Number of Species ","Light Pollution Index ","Terrestrial Vertebrate Biodiversity ")
